...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Brevet.qual_info_question'
        db.delete_column('register_brevet', 'qual_info_question')


    def backwards(self, orm):
        
        # Adding field 'Brevet.qual_info_question'
        db.add_column('register_brevet', 'qual_info_question', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
