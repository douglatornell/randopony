...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EventParticipant.lowercase_last_name'
        db.add_column('register_eventparticipant', 'lowercase_last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)

        # Adding field 'BrevetRider.lowercase_last_name'
        db.add_column('register_brevetrider', 'lowercase_last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EventParticipant.lowercase_last_name'
        db.delete_column('register_eventparticipant', 'lowercase_last_name')

        # Deleting field 'BrevetRider.lowercase_last_name'
        db.delete_column('register_brevetrider', 'lowercase_last_name')
