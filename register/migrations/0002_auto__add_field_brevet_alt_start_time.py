...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Brevet.alt_start_time'
        db.add_column('register_brevet', 'alt_start_time', self.gf('django.db.models.fields.TimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Brevet.alt_start_time'
        db.delete_column('register_brevet', 'alt_start_time')
