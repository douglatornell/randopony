...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Brevet.event'
        db.add_column('register_brevet', 'event', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Brevet.event'
        db.delete_column('register_brevet', 'event')
