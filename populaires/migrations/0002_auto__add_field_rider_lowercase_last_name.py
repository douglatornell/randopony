...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rider.lowercase_last_name'
        db.add_column('populaires_rider', 'lowercase_last_name', self.gf('django.db.models.fields.CharField')(default='', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Rider.lowercase_last_name'
        db.delete_column('populaires_rider', 'lowercase_last_name')
